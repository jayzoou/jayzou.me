const Projects = () => {
  return (
    <div className="m-auto">
      ...
      <div className="flex flex-row flex-wrap gap-4 pl-10 pr-10 justify-start">
        <div className="w-full sm:w-1/3 md:w-1/4 pl-4 pr-4 rounded-lg my-4 bg-black:08 hover:bg-black:20 text-white">
          <a className="block pt-4 pb-4" href="https://asklol.com/" target="_blank" rel="noopener noreferrer">
            <div className="text-6">英雄联盟问答</div>
            <div className="text-3 mt-3">英雄联盟英雄、技能、选手、赛事、云顶之弈相关AI问答平台</div>
          </a>
        </div>
        <div className="w-full sm:w-1/3 md:w-1/4 pl-4 pr-4 rounded-lg my-4 bg-black:08 hover:bg-black:20 text-white">
