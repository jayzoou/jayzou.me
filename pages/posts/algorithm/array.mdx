import twoPointersSvg from './assets/two-pointers.svg'
import slowFastPointersSvg from './assets/slow-fast-pointers.svg'
import palindromeCheckSvg from './assets/palindrome-check.svg'
import removeDuplicatesSvg from './assets/remove-duplicates.svg'
import slidingWindowSvg from './assets/sliding-window.svg'
import fixedSizeSvg from './assets/fixed-size.svg'
...
<div style={{margin: '1rem 0'}}>
  <img src={palindromeCheckSvg} alt="Two pointers animation" style={{maxWidth: '100%'}} />
</div>
...
{/* 插图: 快慢指针 - 原地去重 */}
<div style={{margin: '1rem 0'}}>
  <img src={removeDuplicatesSvg} alt="Two pointers animation" style={{maxWidth: '100%'}} />
</div>
...
{/* 插图: 滑动窗口 - 最长不重复子串 */}
<div style={{margin: '1rem 0'}}>
  <img src={slidingWindowSvg} alt="Two pointers animation" style={{maxWidth: '100%'}} />
</div>
...
{/* 滑动窗口 - 固定大小窗口 */}
<div style={{margin: '1rem 0'}}>
  <img src={fixedSizeSvg} alt="Two pointers animation" style={{maxWidth: '100%'}} />
</div>
