...
今天我们将深入学习**二叉搜索树 (BST)**,这是实现高效查找的关键数据结构。
...
**题目描述**:
给定一个二叉搜索树的根节点 root,和一个整数 k,返回 BST 中第 k 小的元素。
...
**题目描述**:
给你一个整数数组 nums,其中元素已经按升序排列,将其转换为一棵高度平衡的二叉搜索树。
...
**相关资源**:
- [LeetCode BST 题单](https://leetcode.cn/tag/binary-search-tree/)
- [可视化 BST](https://visualgo.net/en/bst)
